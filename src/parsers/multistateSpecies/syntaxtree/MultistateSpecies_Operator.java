...
/**
 * JTB node class for the production MultistateSpecies_Operator:<br>
 ...
 */
public class MultistateSpecies_Operator implements INode {
   ...
   */
  public MultistateSpecies_Operator(final MultistateSpecies_Name n0, final NodeOptional n1) {
