  ...
  public void visit(final MultistateSpecies_SingleStateDefinition n, final A argu) {
    ...
    if (n3.present()) {
      for (int i = 0; i < n3.size(); i++) {
        ...
        n3EiSeqA0.accept(this, argu);
        final INode n3EiSeqA1 = n3EiSeq.elementAt(1);
        n3EiSeqA1.accept(this, argu);
      }
    }
      ...
      case 1:
        ...
        for (int i = 0; i < n0ChNLst.size(); i++) {
          ...
          switch (n0ChNLstEiCh.which) {
            case 0:
              n0ChNLstEiChN.accept(this, argu);
              break;
            case 1:
              n0ChNLstEiChN.accept(this, argu);
              break;
        ...
        case 1:
          ...
          for (int i = 0; i < n1SeqA3ChNLst.size(); i++) {
            ...
            switch (n1SeqA3ChNLstEiCh.which) {
              case 0:
                n1SeqA3ChNLstEiChN.accept(this, argu);
                break;
              case 1:
                n1SeqA3ChNLstEiChN.accept(this, argu);
                break;
