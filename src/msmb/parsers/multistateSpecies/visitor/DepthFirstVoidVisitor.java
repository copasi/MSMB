    ...
    if (n1.present()) {
      ...
      if (n1SeqA2Nlo.present()) {
        for (int i = 0; i < n1SeqA2Nlo.size(); i++) {
          ...
          n1SeqA2NloEiSeqA0.accept(this);
          final INode n1SeqA2NloEiSeqA1 = n1SeqA2NloEiSeq.elementAt(1);
          n1SeqA2NloEiSeqA1.accept(this);
        }
      }
  ...
  public void visit(final MultistateSpecies_SingleStateDefinition n) {
    ...
    if (n3.present()) {
      for (int i = 0; i < n3.size(); i++) {
        ...
        n3EiSeqA0.accept(this);
        final INode n3EiSeqA1 = n3EiSeq.elementAt(1);
        n3EiSeqA1.accept(this);
      }
    }
        ...
        case 1:
          ...
          for (int i = 0; i < n1SeqA3ChNLst.size(); i++) {
            ...
            switch (n1SeqA3ChNLstEiCh.which) {
              case 0:
                n1SeqA3ChNLstEiChN.accept(this);
                break;
              case 1:
                n1SeqA3ChNLstEiChN.accept(this);
                break;
