    ...
    if (n1.present()) {
      ...
      if (n1S0A1T.present()) {
        for (int i = 0; i < n1S0A1T.size(); i++) {
          ...
          n1S0A1TMiS1A0.accept(this);
          // $1 FormalParameter()
          final INode n1S0A1TMiS1A1 = n1S0A1TMiS1.elementAt(1);
          n1S0A1TMiS1A1.accept(this);
        }
      }
    }
    // nodeToken1 -> ")"
  ...
  public void visit(final ArgumentList_MultistateSum_Selectors n) {
    ...
    if (n2.present()) {
      for (int i = 0; i < n2.size(); i++) {
        ...
        n2MiS0A0.accept(this);
        // #1 Selector()
        final INode n2MiS0A1 = n2MiS0.elementAt(1);
        n2MiS0A1.accept(this);
      }
    }
  }
