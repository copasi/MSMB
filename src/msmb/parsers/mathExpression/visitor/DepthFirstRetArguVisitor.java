...
public class DepthFirstRetArguVisitor<R, A> implements IRetArguVisitor<R, A> {
  ...
  public R visit(final IfExpression n, final A argu) {
    ...
    if (n5.present()) {
      ...
      nRes = n5SeqA0.accept(this, argu);
      final INode n5SeqA1 = n5Seq.elementAt(1);
      nRes = n5SeqA1.accept(this, argu);
    }
    ...
    switch (n0Ch.which) {
      case 0:
        ...
        switch (n0ChNCh.which) {
          case 0:
            nRes = n0ChNChN.accept(this, argu);
            break;
          case 1:
            nRes = n0ChNChN.accept(this, argu);
            break;
  ...
  public R visit(final SpeciesReferenceOrFunctionCall_prefix n, final A argu) {
    ...
    if (n1.present()) {
      ...
      if (n1SeqA1Opt.present()) {
        nRes = n1SeqA1Opt.accept(this, argu);
      }
      ...
      case 1:
        ...
        if (n0ChNSeq1A1Nlo.present()) {
          for (int i = 0; i < n0ChNSeq1A1Nlo.size(); i++) {
            ...
            nRes = n0ChNSeq1A1NloEiSeqA0.accept(this, argu);
            final INode n0ChNSeq1A1NloEiSeqA1 = n0ChNSeq1A1NloEiSeq.elementAt(1);
            nRes = n0ChNSeq1A1NloEiSeqA1.accept(this, argu);
          }
        }
        break;
      default:
      ...
      switch (n2Ch.which) {
        case 0:
          ...
          for (int i = 0; i < n2ChNLst.size(); i++) {
            ...
            nRes = n2ChNLstEiSeqA0.accept(this, argu);
            ...
            switch (n2ChNLstEiSeqA1Ch.which) {
              case 0:
                nRes = n2ChNLstEiSeqA1ChN.accept(this, argu);
                break;
              case 1:
                nRes = n2ChNLstEiSeqA1ChN.accept(this, argu);
                break;
        ...
        case 1:
          ...
          nRes = n2ChNSeqA0.accept(this, argu);
          ...
          switch (n2ChNSeqA1Ch.which) {
            case 0:
              nRes = n2ChNSeqA1ChN.accept(this, argu);
              break;
            case 1:
              nRes = n2ChNSeqA1ChN.accept(this, argu);
              break;
