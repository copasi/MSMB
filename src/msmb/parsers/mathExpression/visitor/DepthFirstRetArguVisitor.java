  ...
  public R visit(final AdditiveExpression n, final A argu) {
    ...
    if (n1.present()) {
      for (int i = 0; i < n1.size(); i++) {
        ...
        nRes = n1MiS01A1.accept(this, argu);
      }
    }
    return nRes;
  }
  ...
  public R visit(final UnaryExpressionNotPlusMinus n, final A argu) {
    ...
    switch (n0C.which) {
      case 0:
        ...
        nRes = n0CHS00A1.accept(this, argu);
        break;
      case 1:
        // %1 PrimaryExpression()
        nRes = n0CH.accept(this, argu);
  ...
  public R visit(final PrimaryPrefix n, final A argu) {
    ...
    switch (n0C.which) {
      ...
      case 1:
        ...
        nRes = n0CHS01A0.accept(this, argu);
        // #1 Expression()
        final INode n0CHS01A1 = n0CHS0.elementAt(1);
        nRes = n0CHS01A1.accept(this, argu);
        // #2 <RPAREN>
      ...
      case 1:
        ...
        if (n0CHS01A1T.present()) {
          for (int i = 0; i < n0CHS01A1T.size(); i++) {
            ...
            nRes = n0CHS01A1TMiS1A0.accept(this, argu);
            // $1 AdditiveExpression()
            final INode n0CHS01A1TMiS1A1 = n0CHS01A1TMiS1.elementAt(1);
            nRes = n0CHS01A1TMiS1A1.accept(this, argu);
          }
        }
        break;
      default:
      ...
      switch (n2C.which) {
        case 0:
          ...
          for (int i = 0; i < n2CHL.size(); i++) {
            ...
            nRes = n2CHLEiS0A0.accept(this, argu);
            // #1 ( &0 Name()
            // .. | &1 Literal() )
            ...
            switch (n2CHLEiS0A1C.which) {
              case 0:
                // &0 Name()
                nRes = n2CHLEiS0A1CH.accept(this, argu);
                break;
              case 1:
                // &1 Literal()
                nRes = n2CHLEiS0A1CH.accept(this, argu);
        ...
        case 1:
          ...
          switch (n2CHS0A1C.which) {
            case 0:
              // &0 Name()
              nRes = n2CHS0A1CH.accept(this, argu);
              break;
            case 1:
              // &1 Literal()
              nRes = n2CHS0A1CH.accept(this, argu);
