...
public class DepthFirstVoidArguVisitor<A> implements IVoidArguVisitor<A> {
    ...
    if (n1.present()) {
      ...
      if (n1SeqA1Nlo.present()) {
        for (int i = 0; i < n1SeqA1Nlo.size(); i++) {
          ...
          n1SeqA1NloEiSeqA0.accept(this, argu);
          final INode n1SeqA1NloEiSeqA1 = n1SeqA1NloEiSeq.elementAt(1);
          n1SeqA1NloEiSeqA1.accept(this, argu);
        }
      }
    }
  ...
  public void visit(final IfExpression n, final A argu) {
    ...
    if (n5.present()) {
      ...
      n5SeqA0.accept(this, argu);
      final INode n5SeqA1 = n5Seq.elementAt(1);
      n5SeqA1.accept(this, argu);
    }
    ...
    switch (n0Ch.which) {
      case 0:
        ...
        switch (n0ChNSeq0A0Ch.which) {
          case 0:
            n0ChNSeq0A0ChN.accept(this, argu);
            break;
          case 1:
            n0ChNSeq0A0ChN.accept(this, argu);
            break;
  ...
  public void visit(final PrimaryPrefix n, final A argu) {
    ...
    switch (n0Ch.which) {
      ...
      case 1:
        ...
        n0ChNSeq1A1.accept(this, argu);
        final INode n0ChNSeq1A2 = n0ChNSeq1.elementAt(2);
        n0ChNSeq1A2.accept(this, argu);
        break;
      case 2:
        n0ChN.accept(this, argu);
        break;
  ...
  public void visit(final SpeciesReferenceOrFunctionCall_prefix n, final A argu) {
    ...
    if (n1.present()) {
      ...
      if (n1SeqA1Opt.present()) {
        n1SeqA1Opt.accept(this, argu);
      }
      final INode n1SeqA2 = n1Seq.elementAt(2);
      n1SeqA2.accept(this, argu);
    }
  }
      ...
      case 1:
        ...
        if (n0ChNSeq1A1Nlo.present()) {
          for (int i = 0; i < n0ChNSeq1A1Nlo.size(); i++) {
            ...
            n0ChNSeq1A1NloEiSeqA0.accept(this, argu);
            final INode n0ChNSeq1A1NloEiSeqA1 = n0ChNSeq1A1NloEiSeq.elementAt(1);
            n0ChNSeq1A1NloEiSeqA1.accept(this, argu);
          }
        }
        break;
      default:
  ...
  public void visit(final ArgumentList_MultistateSum_Selectors n, final A argu) {
    ...
    if (n2.present()) {
      for (int i = 0; i < n2.size(); i++) {
        ...
        n2EiSeqA0.accept(this, argu);
        final INode n2EiSeqA1 = n2EiSeq.elementAt(1);
        n2EiSeqA1.accept(this, argu);
      }
    }
  }
      ...
      switch (n2Ch.which) {
        case 0:
          ...
          for (int i = 0; i < n2ChNLst.size(); i++) {
            ...
            n2ChNLstEiSeqA0.accept(this, argu);
            ...
            switch (n2ChNLstEiSeqA1Ch.which) {
              case 0:
                n2ChNLstEiSeqA1ChN.accept(this, argu);
                break;
              case 1:
                n2ChNLstEiSeqA1ChN.accept(this, argu);
                break;
        ...
        case 1:
          ...
          switch (n2ChNSeqA1Ch.which) {
            case 0:
              n2ChNSeqA1ChN.accept(this, argu);
              break;
            case 1:
              n2ChNSeqA1ChN.accept(this, argu);
              break;
